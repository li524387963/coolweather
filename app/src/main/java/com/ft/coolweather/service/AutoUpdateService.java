package com.ft.coolweather.service;
...
import com.ft.coolweather.WeatherActivity;
    ...
    private void updateWeather() {
        ...
        if (weatherString != null){
           //有缓存时直接解析天气数据
            ...
            String weatherUrl = "http://guolin.tech/api/weather?cityid="+weatherId + "&key=4cdb162ab5804c5da3900a16cefbd953";
